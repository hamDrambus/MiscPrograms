...
namespace gPars
{
  struct ProgramSetups {
    ...
    std::string input_XS_filename;
    std::string input_S_filename; // Average structure factor S(e)
    std::string output_XS_filename;
    bool input_is_effective_XS; // if false, then input is momentum transfer (MT) XS. MT_XS = Eff_XS * S(e).
